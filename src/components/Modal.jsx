...
export default function Modal({ isModalOpen, toggleModal }) {
        ...
        <div className="container modal__container">
          <div className="row modal__row">
            ...
            <p className="modal__para">
              Hey there! My name is <b className="color--text">Rafael Shay</b>{" "}
              and I'm a{" "}
              <b className="color--text">Frontend Software Engineer</b> who
